...
public class PlayerStateUI : MonoBehaviour
{
   ...
   private Image _PlayerSlidingImage;
    ...
    private void PlayerController_OnPlayerStateChanged(PlayerState playerState)
    {
        switch(playerState)
        {
            ...
            case PlayerState.slide:
                 ...
                 SetStateUserInterface(_playerSlidingActiveSprite, _playerWalkingPassiveSprite, _playerSlidingTransform, _playerWalkingTransform);
                 break;
        }
    ...
    public void PlayBoostersUIAnimations(RectTransform activeTransform, Image boosterImage, Image wheatImage, 
    Sprite activeSprite, Sprite passiveSprite, Sprite activeWheatSprite, Sprite passiveWheatSprite, float duration)
    {
