...
{
    [Header("References")]
     [SerializeField] private RectTransform _timerRotarableTransform;
    ...
    {
        _rotationTween = _timerRotarableTransform.DORotate(new Vector3(0f, 0f, -360f), _rotationDuration, RotateMode.FastBeyond360)
