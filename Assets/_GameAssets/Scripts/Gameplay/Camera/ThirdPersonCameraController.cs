...
{   [Header("References")]
    ...
    private void Update()
    {
        ...
        // Slerp versiyonu rotasyon için (animasyonlu), Lerp versiyonu ise pozisyonlarımız için //Time.deltaTime fps farklılıkları olan PC ler için saniye değerini eşitlemiş oldu. 
